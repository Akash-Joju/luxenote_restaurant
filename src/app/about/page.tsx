  ...
  return (
    <section className="max-w-5xl mx-auto px-6 py-20 text-center">
      <h2 className="text-4xl font-bold mb-6 text-gray-900">
        Welcome to <span className="text-indigo-600">Burpies</span>
      </h2>
      <p className="text-lg text-gray-700 leading-8 mb-10">
        At <strong>Burpies</strong>, we don&apos;t just serve meals—we craft unforgettable
        culinary experiences. Nestled in the heart of the varandarapilly, our restaurant blends
      ...
      <div className="grid md:grid-cols-2 gap-10 text-left">
        <div>
          ...
          <p className="text-gray-600 leading-7">
            ...
            global influences. Every dish at Burpies is made with locally sourced,
            seasonal ingredients and presented with artful precision.
          </p>
        </div>

        <div>
          <h3 className="text-2xl font-semibold text-gray-800 mb-3">Experience Burpies</h3>
          <p className="text-gray-600 leading-7">
            From  dinners to grand celebrations, burpies offers a luxurious
      ...
      <div className="mt-12">
        <p className="text-md text-gray-700">
          ...
          we promise an extraordinary experience. Come taste the difference at Burpies
        </p>
      </div>
    </section>
  )
